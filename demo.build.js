...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactProsemirror = __webpack_require__(157);
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								'label',
								null,
								_react2['default'].createElement('input', { type: 'checkbox', checkedLink: this.optionLink('inlineMenu') }),
								'inlineMenu'
							),
							_react2['default'].createElement(
								'label',
								null,
								_react2['default'].createElement('input', { type: 'checkbox', checkedLink: this.optionLink('buttonMenu') }),
								'buttonMenu'
							),
							_react2['default'].createElement(
								'select',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _prosemirrorSrcEditMain = __webpack_require__(158);
	...
	exports['default'] = _react2['default'].createClass({
		...
		componentWillMount: function componentWillMount() {
			...
			this.pm = new _prosemirrorSrcEditMain.ProseMirror(Object.assign({ doc: this._lastValue }, this.props.options));
		},
		componentDidMount: function componentDidMount() {
			var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transform = __webpack_require__(168);

	var _options = __webpack_require__(178);

	var _selection = __webpack_require__(182);

	var _dom = __webpack_require__(181);

	var _draw = __webpack_require__(183);
	...
	var _convertTo_text = __webpack_require__(188);

	__webpack_require__(194);

	var _convert = __webpack_require__(185);

	var _commands = __webpack_require__(189);
	...
	var ProseMirror = (function () {
	  function ProseMirror(opts) {
	    ...
	    this.setDocInner(opts.docFormat ? (0, _convert.convertFrom)(opts.doc, opts.docFormat, { document: document }) : opts.doc);
	  ...
	  _createClass(ProseMirror, [{
	    ...
	    value: function setContent(value, format) {
	      if (format) value = (0, _convert.convertFrom)(value, format, { document: document });
	      this.setDoc(value);
	    }
	  }, {
	    key: "getContent",
	    value: function getContent(format) {
	      return format ? (0, _convert.convertTo)(this.doc, format, { document: document }) : this.doc;
	    }
	  }, {
	    key: "setDocInner",
	    ...
	    value: function setStyle(st, to) {
	      ...
	      if (sel.empty) {
	        ...
	        if (to == null) to = !_model.style.containsType(styles, st.type);
	        this.input.storedStyles = to ? _model.style.add(styles, st) : _model.style.removeType(styles, st.type);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _insertCss = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pos = __webpack_require__(164);
	...
	var _slice = __webpack_require__(165);
	...
	var _inline = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _step = __webpack_require__(171);
	...
	var _ancestor = __webpack_require__(176);
	...
	var _join = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _step2 = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaultkeymap = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _convertTo_dom = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _convertFrom_dom = __webpack_require__(187);
	...
	var _domchange = __webpack_require__(191);
	...
	handlers.paste = function (pm, e) {
	  ...
	  if (html || txt) {
	    ...
	    if (pm.input.shiftKey && txt) {
	      ...
	      doc = (0, _convert.convertFrom)(txt, (0, _convert.knownSource)("markdown") ? "markdown" : "text");
	    }
	...
	handlers.drop = function (pm, e) {
	  ...
	  var html = undefined,
	      txt = undefined,
	      doc = undefined;
	  if (html = e.dataTransfer.getData("text/html")) doc = (0, _convertFrom_dom.fromHTML)(html, { document: document });else if (txt = e.dataTransfer.getData("text/plain")) doc = (0, _convert.convertFrom)(txt, (0, _convert.knownSource)("markdown") ? "markdown" : "text");
...
/***/ function(module, exports, __webpack_require__) {
	...
	function fromDOM(dom, options) {
	  ...
	  var doc = context.stack[0];
	  if (!_model.Pos.start(doc)) doc.push(new _model.Node("paragraph"));
	  return doc;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _char = __webpack_require__(190);
	...
	commands.setStrong = function (pm) {
	  return pm.setStyle(_model.style.strong, true);
	};
	commands.unsetStrong = function (pm) {
	  return pm.setStyle(_model.style.strong, false);
	};
	commands.toggleStrong = function (pm) {
	  return pm.setStyle(_model.style.strong, null);
	};

	commands.setEm = function (pm) {
	  return pm.setStyle(_model.style.em, true);
	};
	commands.unsetEm = function (pm) {
	  return pm.setStyle(_model.style.em, false);
	};
	commands.toggleEm = function (pm) {
	  return pm.setStyle(_model.style.em, null);
	};

	commands.setCode = function (pm) {
	  return pm.setStyle(_model.style.code, true);
	};
	commands.unsetCode = function (pm) {
	  return pm.setStyle(_model.style.code, false);
	};
	commands.toggleCode = function (pm) {
	  return pm.setStyle(_model.style.code, null);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transformTree = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function fromText(text) {
	  ...
	  if (!doc.content.length) doc.push(new _model.Node("paragraph"));
	  return doc;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputrules = __webpack_require__(200);
	...
	function wrapAndJoin(pm, pos, type) {
	  ...
	  var sibling = before.offset > 0 && pm.doc.path(before.path).content[before.offset - 1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilDebounce = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InlineStyleItem = (function (_IconItem5) {
	  ...
	  _createClass(InlineStyleItem, [{
	    ...
	    key: "apply",
	    value: function apply(pm) {
	      if (this.active(pm)) pm.setStyle(this.style, false);else if (this.dialog) return [this.dialog];else pm.setStyle(this.style, true);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _editSelection = __webpack_require__(182);
